...
public class CurrentOrderTest extends ActivityInstrumentationTestCase2<CurrentOrdersActivity> {
    ...
    private CurrentOrdersActivity cActivity;

    public CurrentOrderTest() {
    ...
    public void setUp() throws Exception {
        ...
        cActivity.setWaitingOrdersForTesting(orderElements);
        Thread.sleep(10000);
    }
    ...
    public void testListInvisble() throws InterruptedException {
        onView(withId(R.id.listCurrentOrders)).check(matches(withEffectiveVisibility(ViewMatchers.Visibility.GONE)));
    }
    @Test
    ...
    public void testVisibilityAfterClick(){
        ...
        onView(withId(R.id.listCurrentOrders)).check(matches(withEffectiveVisibility(ViewMatchers.Visibility.VISIBLE)));
        onView(withId(R.id.button_list_mode)).perform(click());
    ...
    public void testIfNoOrders() throws InterruptedException {
        cActivity.resetCurrentOrder();
        cActivity.resetWaitingOrders();
        onView(withId(R.id.button_list_mode)).perform(click());
        onData(anything())
